...
*/
            ...
            /* had a look whether this helped. It did, a bit.
             * Something like
CFLAGS="-L$HOME/local/lib -I$HOME/local/include -O3 -Wall" ./configure --prefix=$HOME/local
             * should do it, provided you were able to intall gperftools and libunwind
             * I found it tricky and was possibly helped along by
CPPFLAGS="-I$HOME/local/include" CFLAGS="-I$HOME/local/include" LD_RUN_PATH=$HOME/local/lib ./configure --prefix=$HOME/local/
             * and
(ebi-002|mcl/mcl) grep unwind include/*
include/include.am:AM_LDFLAGS = -lm -lunwind -ltcmalloc
            */
