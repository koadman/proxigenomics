...
def generate_wgs(outdir, c):
	...
	action = 'cd {od} && /panfs/panspermia/120274/work/hi-c/sim/bin/pbsrun_ART.sh {0[seed]} {0[wgs_insert_length]} {0[wgs_insert_sd]} {0[wgs_read_length]} {0[wgs_xfold]} $SOURCE.abspath {0[wgs_base]}'.format(c,od=outdir)
