...
then
	...
	# Queue submission
	CMD=`readlink -f $0`
	qsub -q $QUEUE -pe smp $NCPU $WAITOPT -l h_vmem=${MEM}G -v MEM=$MEM,NCPU=$NCPU,TAG=$TAG,OVERWRITE=$OVERWRITE,OPTIONS=$CAREFUL,READ1=$R1,READ2=$R2,OUTDIR=$3 $CMD
	echo "Finished"
